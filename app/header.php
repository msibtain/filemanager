...
<head>
  ...
  <link href="assets/css/app.css?t=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
  <!-- favicon -->
          ...
          <ul class="nav navbar-nav pull-right">
            ...
            <li class="dropdown dropdown-user">
              <a class="dropdown-toggle" data-bs-toggle="dropdown" data-hover="dropdown"
                ...
                <span class="username username-hide-on-mobile"> <?php echo ucwords($_SESSION['login_name']) ?> </span>
